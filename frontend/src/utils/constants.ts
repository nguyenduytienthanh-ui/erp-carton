...
export const API_ENDPOINTS = {
  ...
  PRODUCTION_ISSUES: '/production/issues/',
  PRODUCTION_RECEIPTS: '/production/receipts/',
  QUALITY_PRINTING_INSPECTIONS: '/quality/printing-inspections/',
  QUALITY_VISION_JOBS: '/quality/vision-jobs/',
  QUALITY_IMAGE_ARTIFACTS: '/quality/image-artifacts/',
  QUALITY_STORAGE_SETTINGS: '/quality/storage-settings/',
  QUALITY_IMAGE_RETENTION_POLICIES: '/quality/image-retention-policies/',
