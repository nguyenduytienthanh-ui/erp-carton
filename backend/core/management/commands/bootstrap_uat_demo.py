...
ROLE_MATRIX = [
    ...
    },
    {
        ...
        'permissions': [
            ...
            'PURCHASING:MANAGE', 'PURCHASEORDER:SUBMIT', 'PURCHASEORDER:APPROVE', 'PURCHASEORDER:REJECT', 'PURCHASEORDER:RECEIVE', 'PURCHASEORDER:CANCEL',
    ...
    },
    {
        ...
        'permissions': [
            ...
            'PURCHASING:MANAGE', 'PURCHASEORDER:APPROVE', 'PURCHASEORDER:REJECT', 'PURCHASEORDER:CANCEL',
    ...
    },
    {
        ...
        'permissions': [
            ...
            'INVENTORY:MANAGE', 'PURCHASING:MANAGE', 'PURCHASEORDER:SUBMIT', 'PURCHASEORDER:RECEIVE',
