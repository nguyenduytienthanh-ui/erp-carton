...
PERMISSIONS = [
    ...
    *[
    ...
    ('SALESORDER', 'VIEW', 'SALESORDER_VIEW', 'View sales orders'),
...
ROLE_MATRIX = [
    ...
    },
    {
        ...
        'permissions': [
            ...
            'PRODUCTION:VIEW', 'PRODUCTION:MANAGE', 'PRODUCTION:PLAN', 'PRODUCTION:ISSUE', 'PRODUCTION:RECEIVE', 'PRODUCTION:CANCEL',
            'PRODUCTIONORDER:SUBMIT', 'PRODUCTIONORDER:APPROVE', 'PRODUCTIONORDER:REJECT', 'PRODUCTIONORDER:RELEASE', 'PRODUCTIONORDER:ISSUE', 'PRODUCTIONORDER:RECEIVE', 'PRODUCTIONORDER:CANCEL',
            ...
            'SALESORDER:VIEW', 'SALESORDER:SUBMIT', 'SALESORDER:APPROVE', 'SALESORDER:REJECT', 'SALESORDER:POST', 'SALESORDER:VOID',
    ...
    },
    {
        ...
        'permissions': [
            ...
            'PRODUCTION:VIEW', 'PRODUCTION:MANAGE', 'PRODUCTION:CANCEL', 'PRODUCTIONORDER:APPROVE', 'PRODUCTIONORDER:REJECT', 'PRODUCTIONORDER:CANCEL',
            'CORE:VIEW_REPORTS',
            'SUPPLIER:VIEW', 'SUPPLIER:CREATE', 'SUPPLIER:EDIT', 'SUPPLIER:EXPORT',
            'SALESORDER:VIEW', 'SALESORDER:POST', 'SALESORDER:VOID',
        ],
    },
    {
        'code': 'ACCOUNTANT',
        'name': 'Accountant',
        'sort_order': 40,
        'permissions': ['FINANCE:MANAGE', 'CORE:VIEW_REPORTS', 'SALESORDER:VIEW', 'SALESORDER:POST'],
    },
    {
        'code': 'HR_MANAGER',
        'name': 'HR Manager',
    ...
    },
    {
        ...
        'permissions': [
            ...
            'PRODUCTION:VIEW', 'PRODUCTION:MANAGE', 'PRODUCTION:PLAN', 'PRODUCTION:ISSUE', 'PRODUCTION:RECEIVE',
            'PRODUCTIONORDER:SUBMIT', 'PRODUCTIONORDER:RELEASE', 'PRODUCTIONORDER:ISSUE', 'PRODUCTIONORDER:RECEIVE',
        ],
    },
    {
        'code': 'AUDITOR',
    ...
    },
    {
        ...
        'sort_order': 90,
        'permissions': ['SALESORDER:VIEW', 'SALESORDER:SUBMIT', 'CUSTOMER:VIEW', 'CUSTOMER:CREATE', 'CUSTOMER:EDIT', 'CUSTOMER:SUBMIT'],
    },
    {
        'code': 'SALES_MANAGER',
        'name': 'Sales Manager',
        'sort_order': 100,
        'permissions': [
            'SALESORDER:VIEW', 'SALESORDER:SUBMIT', 'SALESORDER:APPROVE', 'SALESORDER:REJECT', 'SALESORDER:VOID',
    ...
    },
    {
        ...
        'permissions': [
            ...
            'SUPPLIER:VIEW', 'SUPPLIER:CREATE', 'SUPPLIER:EDIT',
            'PRODUCTION:VIEW', 'PRODUCTION:MANAGE', 'PRODUCTION:PLAN', 'PRODUCTION:ISSUE', 'PRODUCTION:RECEIVE',
            'PRODUCTIONORDER:SUBMIT', 'PRODUCTIONORDER:RELEASE', 'PRODUCTIONORDER:ISSUE', 'PRODUCTIONORDER:RECEIVE', 'CORE:VIEW_REPORTS',
        ],
    },
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write('Demo password in this run: [masked]')
        for item in summary:
