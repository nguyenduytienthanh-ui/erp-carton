...
PERMISSIONS = [
    ...
    ('INVENTORY', 'MANAGE', 'INVENTORY_MANAGE', 'Manage Inventory module'),
...
ROLE_MATRIX = [
    ...
    },
    {
        ...
        'sort_order': 20,
        'permissions': [
            'WORKFORCE:MANAGE', 'FINANCE:MANAGE', 'INVENTORY:MANAGE',
            'OPS:VIEW', 'WORKFLOW:VIEW', 'WORKFLOW:MANAGE',
    ...
    },
    {
        ...
        'sort_order': 30,
        'permissions': ['FINANCE:MANAGE', 'CORE:VIEW_OPERATIONS_LOG', 'SALESORDER:POST', 'SALESORDER:VOID'],
    },
    {
        'code': 'ACCOUNTANT',
        'name': 'Accountant',
        'sort_order': 40,
        'permissions': ['FINANCE:MANAGE', 'SALESORDER:POST'],
    },
    {
        'code': 'HR_MANAGER',
        'name': 'HR Manager',
    ...
    },
    {
        ...
        'sort_order': 70,
        'permissions': ['OPS:VIEW', 'WORKFLOW:VIEW', 'WORKFLOW:MANAGE', 'CORE:VIEW_OPERATIONS_LOG', 'INVENTORY:MANAGE'],
    },
    {
        'code': 'AUDITOR',
        'name': 'Auditor',
    ...
    },
    {
        ...
        'name': 'Sales Manager',
        'sort_order': 100,
        'permissions': ['SALESORDER:SUBMIT', 'SALESORDER:APPROVE', 'SALESORDER:REJECT', 'SALESORDER:VOID', 'INVENTORY:MANAGE'],
    },
    {
        'code': 'PRODUCT_MANAGER',
        'name': 'Product Manager',
        'sort_order': 110,
        'permissions': ['PRODUCTCATEGORY:EDIT', 'PRODUCTUNIT:EDIT', 'PRODUCT:EDIT', 'PRODUCT:IMPORT', 'INVENTORY:MANAGE'],
    },
]
