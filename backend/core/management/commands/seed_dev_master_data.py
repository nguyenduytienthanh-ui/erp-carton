...
from core.dev_seed import seed_dev_master_data


class Command(BaseCommand):
    help = 'Seed idempotent dev master data without creating demo orders.'
    ...
    def handle(self, *args, **options):
        ...
        if options.get('json'):
            ...
            return
        self.stdout.write(self.style.SUCCESS('Dev master data seeded.'))
